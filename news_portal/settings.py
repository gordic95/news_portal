...
SECRET_KEY = 'django-insecure-v%qbf^@efy9^f-2ekh=9&694%%xm-=+hk#j=y2y_g=$&f17kj('
...
INSTALLED_APPS = [
    ...
    'django.contrib.sites', #для авторизации
...
LOGOUT_REDIRECT_URL = '/news/posts/'
...
#форма добавления в группу common при регистрации
